  ...
  return (
   <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div>
                    <p className='font-playfair text-base text-gray-800 mb-3'>QUICK LINKS</p>
                    <ul className='flex flex-col gap-2 text-sm'>
                        <li><a href='/' className='hover:text-gray-700 transition-colors'>Home</a></li>
                        <li><a href='/rooms' className='hover:text-gray-700 transition-colors'>Browse Houses</a></li>
                ...
                <div>
                    <p className='font-playfair text-base text-gray-800 mb-3'>LEGAL</p>
                    <ul className='flex flex-col gap-2 text-sm'>
                        ...
                        <li><a href='/unlock-policy' className='hover:text-gray-700 transition-colors'>Unlock Fee Policy</a></li>
                        <li><a href='/safety' className='hover:text-gray-700 transition-colors'>Safety Tips</a></li>
                    </ul>
                </div>

                <div className='max-w-72'>
                    <p className='font-playfair text-base text-gray-800 mb-3'>STAY UPDATED</p>
                    ...
                    {status === 'done' ? (
                      ...
                      <form onSubmit={handleSubscribe} className='flex items-center'>
                        <input
                          ...
                          className='bg-white rounded-l border border-gray-300 h-9 px-3 outline-none text-sm flex-1 min-w-0'
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p className='text-sm'>© {new Date().getFullYear()} CampusCrib. All rights reserved.</p>
